// Bicep bicepparam entries generated by main.py on Sat Oct 18 18:13:06 2025
...
param azureOpenaiVersion = readEnvironmentVariable('CAIG_AZURE_OPENAI_VERSION')
...
param graphSourcePath = readEnvironmentVariable('CAIG_GRAPH_SOURCE_PATH')
...
param promptCompletionPath = readEnvironmentVariable('CAIG_PROMPT_COMPLETION_PATH')
param promptSparqlPath = readEnvironmentVariable('CAIG_PROMPT_SPARQL_PATH')
