...
public class AppConfig {
    ...
    /**
     * Attempt to read the .override_properties file in the caig directory.
    ...
    public static void initialize() {
        ...
        logger.warn("ApplicationConfig#initialize at " + initialzedEpoch);
        overrideProperties = new Properties();
        try {
            String userDirectory = System.getProperty("user.dir");
            String infile = String.format("%s%s%s", userDirectory, File.separator, ".override.properties");
            logger.warn("ApplicationConfig#initialize reading infile: " + infile);
    ...
    public static void logDefinedEnvironmentVariables() {
        ...
        //logger.warn("EnvVar name: " + name + ", value: " + value);
    }
