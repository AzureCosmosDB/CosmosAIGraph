...
class AiConversation:
    ...
    def __init__(self, json_obj=None):
        try:
            if json_obj is not None:
                ...
                if "app_chat_history" in json_obj.keys():
                    self.app_chat_history = json_obj["app_chat_history"]
                else:
                    self.app_chat_history = list()
    ...
    def get_app_chat_history(self):
        return self.app_chat_history
    ...
    def get_message_count(self):
        try:
            return len(self.app_chat_history)
        except Exception as e:
            return -1
    ...
    def add_user_message(self, msg: str) -> None:
        try:
            if (msg is not None) and (len(msg) > 0):
                self.app_chat_history.append(msg)
    ...
    def add_message(
        ...
        try:
            self.app_chat_history.append(message)
    ...
    def get_data(self) -> dict:
        ...
        try:
            ...
            data["app_chat_history"] = self.app_chat_history
            data["chat_history"] = json.loads(self.chat_history.serialize())
            data["diagnostic_messages"] = self.diagnostic_messages
