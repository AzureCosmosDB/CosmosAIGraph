"""
Usage:
    python main_code_gen.py <function>
    python main_code_gen.py generate <namespace>
    python main_code_gen.py generate http://yourdomain.com/your_app_abbreviation
    python main_code_gen.py generate http://nf.com/hg
Options:
...
#
# TODO: Refactor this script to generate Java/Jena rather than Python/Rdflib.
#
